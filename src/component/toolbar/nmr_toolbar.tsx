  ...
  const toolItems: Array<ToolItem | PopoverToolItem> = [
    ...
    },
    {
      ...
      tooltip: {
        ...
        link: '#/docs/30_2d-spectra/slicing',
      },
      icon: <PiKnifeBold />,
    },
    {
